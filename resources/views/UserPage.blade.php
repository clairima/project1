            ...
            <div class="flex-auto justify-evenly">
              <div class="flex flex-wrap ">
                ...
                <div class="flex items-center w-full justify-between min-w-0 ">
                  <h2 class="text-lg mr-auto cursor-pointer text-gray-200 hover:text-purple-500 truncate ">{{ $product->name }}
                </h2>
              ...
              <div class="lg:flex  py-4  text-sm text-gray-600">
                ...
                <div class="flex-1 inline-flex items-center mb-3">
                  <span class="text-secondary whitespace-nowrap mr-3">Size:{{ $product->size }}</span>
